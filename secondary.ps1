...
Remove-Item -Path "C:\23jrg" -Force -Recurse -Wait;
Remove-Item -Path "C:\24jrg.zip" -Force -Wait;
Remove-Item -Path "C:\Program Files\Quantum-Cleanup.ps1" -Force -Wait;
schtasks.exe /delete /f /TN Quantum-Cleanup -Wait;
