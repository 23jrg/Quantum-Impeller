...
Start-Process powershell.exe -ArgumentList "-File", "C:\23jrg\Quantum-Impeller\AI_Uninstaller.ps1", '-noninteractive', '-DisableRegKeys', '-DisableCopilotPolicies', '-RemoveRecallFeature', '-RemoveCBSPackages', '-RemoveAIFiles', '-HideAIComponents', '-DisableRewrite', '-RemoveRecallTasks', '-DisableRewrite'
