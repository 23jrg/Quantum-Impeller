...
invoke-expression 'cmd /c start powershell -Command {winget install ZhornSoftware.Caffeine --source winget --force}';
...
;invoke-expression 'cmd /c start powershell -Command {Caffeine -activefor:15 -replace}';git clone https://github.com/23jrg/Kick-Inactive-Users;.\Kick-Inactive-Users\setup.bat;
