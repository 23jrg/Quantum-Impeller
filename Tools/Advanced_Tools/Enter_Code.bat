...
echo start PowerShell -WindowStyle Hidden -Command "Add-WindowsCapability -Online -Name WMIC;Enable-WindowsOptionalFeature -Online -FeatureName NetFx3 -All" >> Tron.bat
